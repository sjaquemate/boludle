...
export const CORRECT_WORD_MESSAGE = (solution: string) => `La palabra era ${solution}, boludle`

export const GUESS_MUST_CONTAIN_MESSAGE = (letter: string) => `La palabra debe contener ${letter}`
export const MUST_USE_LETTER_IN_POSITION_MESSAGE = (letter: string, pos: number ) =>
